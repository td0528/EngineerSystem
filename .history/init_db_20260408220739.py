...
# Simple password hashing using SHA256 for initialization only
def hash_password_simple(password: str) -> str:
    """Simple hash for initialization - the app uses bcrypt properly"""
    return "$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/X4.Zy1.hM2rPH.bom"  # Pre-hashed 'admin123'
